...
const FALLBACK_JOURNEYS: JourneyItem[] = [
  { n: 1, icon: '🤗', title: 'Acolhimento e Chegada', sub: '"Você não está sozinho"', color: '#1ab6a9' },
  { n: 2, icon: '🧩', title: 'Compreendendo o TEA', sub: '"Informação que acolhe e aproxima"', color: '#9B75C7' },
  { n: 3, icon: '💭', title: 'Sentimentos diante do diagnóstico', sub: '"Tudo que você sente merece espaço"', color: '#3fc4b8' },
  { n: 4, icon: '🔍', title: 'Autoavaliação e Autopercepção', sub: '"Como você está, de verdade?"', color: '#0f8a80' },
  { n: 5, icon: '🌱', title: 'Cuidar de Si para Continuar', sub: '"Você também precisa de cuidado"', color: '#1ab6a9' },
  { n: 6, icon: '🛠️', title: 'Estratégias de Manejo com a Criança', sub: '"Compreender antes de reagir"', color: '#9B75C7' },
  { n: 7, icon: '🤝', title: 'A Rede de Apoio', sub: '"Cuidar é um trabalho coletivo"', color: '#3fc4b8' },
  { n: 8, icon: '📋', title: 'Direitos, Deveres e Orientações', sub: '"Informação também é cuidado"', color: '#0f8a80' },
  { n: 9, icon: '🌊', title: 'Momentos de Crise', sub: '"Quando tudo parece demais"', color: '#1ab6a9' },
  { n: 10, icon: '⚡', title: 'Como o Cérebro Aprende', sub: '"Entender o cérebro muda o cuidado"', color: '#9B75C7' },
  { n: 11, icon: '🌟', title: 'Potencialidades, Identidade e Futuro', sub: '"Para além do diagnóstico"', color: '#3fc4b8' },
  { n: 12, icon: '🏫', title: 'Escola, Sociedade e Inclusão', sub: '"Cuidar também é enfrentar o mundo"', color: '#0f8a80' },
]
